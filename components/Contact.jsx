            ...
            <div className="contact-grid">
                <div className="contact-info glass-card">
                    ...
                    <div className="social-links" style={{ marginBottom: '2rem' }}>
                        <a href="mailto:cyedfarhandanish@gmail.com" target="_blank" rel="noopener noreferrer" className="social-item">
                        ...
                        <a href="tel:+923465092108" target="_blank" rel="noopener noreferrer" className="social-item">
                    ...
                    <div className="badge-base LI-profile-badge" data-locale="en_US" data-size="medium" data-theme="dark" data-type="VERTICAL" data-vanity="syedfarhandanish" data-version="v1">
                        <a className="badge-base__link LI-simple-link" href="https://pk.linkedin.com/in/syedfarhandanish?trk=profile-badge" target="_blank" rel="noopener noreferrer">Syed Farhan Danish</a>
                    </div>
                </div>
